  ...
  return (
    <div className="space-y-3">
      <div
        ...
        onDrop={handleDrop}
        onClick={() => !uploading && document.getElementById('additional-logos-input')?.click()}
        ...
        <div className="flex flex-col items-center gap-2 text-center">
          {uploading ? (
            ...
            <>
              ...
              <p className="text-sm font-medium">Drag & drop multiple logos here</p>
