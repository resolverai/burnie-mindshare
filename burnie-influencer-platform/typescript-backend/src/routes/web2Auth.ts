...
router.get('/twitter/login', async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const callbackUrl = (redirect_uri as string) || process.env.TWITTER_CALLBACK_URL_WEB2 || 'https://mining.dvyb.ai/web2/twitter-callback';
...
const handleTwitterCallback = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const callbackUrl = process.env.TWITTER_CALLBACK_URL_WEB2 || 'https://mining.dvyb.ai/web2/twitter-callback';
...
router.get('/linkedin/login', async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const callbackUrl = (redirect_uri as string) || process.env.LINKEDIN_CALLBACK_URL_WEB2 || 'https://mining.dvyb.ai/web2/linkedin-callback';
...
router.post('/linkedin/callback', async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const callbackUrl = process.env.LINKEDIN_CALLBACK_URL_WEB2 || 'https://mining.dvyb.ai/web2/linkedin-callback';
...
router.get('/youtube/login', async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const callbackUrl = (redirect_uri as string) || process.env.YOUTUBE_CALLBACK_URL_WEB2 || 'https://mining.dvyb.ai/web2/youtube-callback';
...
router.post('/youtube/callback', async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const callbackUrl = process.env.YOUTUBE_CALLBACK_URL_WEB2 || 'https://mining.dvyb.ai/web2/youtube-callback';
