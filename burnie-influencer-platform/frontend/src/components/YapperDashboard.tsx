          ...
          <button
            onClick={() => {
              ...
              if (isMobile) {
                ...
                console.log('📱 Mobile wallet connection initiated from dashboard:', currentPath);
              } else {
                console.log('🖥️ Desktop wallet connection initiated from dashboard:', currentPath);
              }
            ...
            return (
              <div key={item.id} className="relative group">
                <button
                  ...
                  className={`w-full group flex items-center rounded-md px-2 py-2 text-sm transition-colors overflow-hidden justify-start ${
                    isActive 
