...
export default function YapperAnalytics() {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-shrink-0 p-6 border-b border-yapper">
      ...
      {/* Top 4 Metrics Cards - Full Width */}
      <div className="flex-shrink-0 p-6 border-b border-yapper">
      ...
      {/* Main Content Area - 2 Column Layout with Clear Separation */}
      <div className="flex-1 flex min-h-0">
        {/* Left Column - Main Content Area */}
        <div className="flex-1 border-r border-yapper overflow-y-auto">
          <div className="p-6 space-y-6">
            ...
            <div className="bg-yapper-surface-2 rounded-xl p-6 border border-yapper">
              ...
              <div className="space-y-4">
                {/* Gaming Content Performance Bars */}
                {[1, 2, 3].map((index) => (
                  <div key={index}>
