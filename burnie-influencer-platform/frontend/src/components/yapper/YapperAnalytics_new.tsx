...
const performanceData = [
  { name: 'Mon', earnings: 45, community: 30 },
  { name: 'Tue', earnings: 52, community: 35 },
  { name: 'Wed', earnings: 48, community: 32 },
  { name: 'Thu', earnings: 61, community: 38 },
  { name: 'Fri', earnings: 55, community: 40 },
  { name: 'Sat', earnings: 67, community: 42 },
  { name: 'Sun', earnings: 72, community: 45 }
]
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-yapper-muted text-sm mt-1">AI powered insights to maximise your platform rewards and leaderboard climbing</p>
          </div>
          <div className="flex items-center space-x-2">
            <button className="px-4 py-2 bg-yapper-muted text-white rounded-lg text-sm">24h</button>
            <button className="px-4 py-2 bg-orange-600 text-white rounded-lg text-sm">7d</button>
            <button className="px-4 py-2 bg-yapper-muted text-white rounded-lg text-sm">30d</button>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-yapper-surface-2 rounded-xl p-4 border border-yapper">
          ...
          <p className="text-white text-2xl font-bold mb-1">$3450</p>
        ...
        <div className="bg-yapper-surface-2 rounded-xl p-4 border border-yapper">
          ...
          <p className="text-white text-2xl font-bold mb-1">156.7%</p>
        ...
        <div className="col-span-8 space-y-6">
          ...
          <div className="bg-yapper-surface-2 rounded-xl p-6 border border-yapper">
            ...
            <div className="space-y-4">
              {/* Gaming Content Performance Bar */}
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-white">Gaming Content</span>
                  <span className="text-orange-400">Your: 156, Community: 98</span>
                </div>
