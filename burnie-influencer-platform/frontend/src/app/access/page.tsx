            ...
            <button
              onClick={() => {
                ...
                if (isMobile) {
                  ...
                  console.log('📱 Mobile wallet connection initiated from access page:', currentPath);
                } else {
                  console.log('🖥️ Desktop wallet connection initiated from access page:', currentPath);
                }
