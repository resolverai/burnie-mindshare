...
def _load_meta_ads_fetch():
    """Load meta-ads-fetch module (filename has hyphen)."""
    import importlib.util
    mod_path = Path(__file__).parent / "meta-ads-fetch.py"
...
def fetch_and_enrich_ads(
    *,
    ...
    meta-ads-fetch downloads creatives to out_dir (same as manual script).
    """
